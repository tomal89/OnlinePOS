...
<table width="1083"  height="38" border="0" style="background:#FBFBFD; margin-left:0;-moz-border-radius:3px; table-layout:auto; margin-top:5px; margin-bottom:3px;">
  <tr>
    ...
    <a style='text-decoration: none; color:Blue;' href="item_f.php">Item Entry</a>->View Details</td>
...
<table width="760" height="600" border="0" style="background:#FBFBFD;">
  <tr>
    <td width="17" valign="top">&nbsp;</td>
    <td width="733" valign="top">
<form  oninput="i_total_price.value = String(i_qun.value) * String(i_per_price.value)
i_due.value= String(i_total_price.value) - String(i_paid.value)" 
...
<p>
  ...
  <label>Item Total Cost:</label> 
              ...
              <input type="text" pattern="[\d* . ]+"  name="i_total_price"  readonly  for="i_qun i_price"  aria-required="true" 
              placeholder="Total Price" value="<?php echo $i_total_price; ?>">

              
              </br>
        <p>
   <label>Paid Amount:</label> 
   <input type="text" pattern="[\d* . ]+" name="i_paid"  aria-required="true" placeholder="integer value like 1.2.3." size="50"value="<?php echo $i_paid; ?>"></br>
        <p>
     <p>
   <label>Due Amount:</label> 
   <input type="text"  name="i_due" for="i_price i_paid"  size="50"  readonly placeholder="There was no due amount." value="<?php echo $i_due; ?>"></br>
        <p>
