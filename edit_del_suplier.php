...
$query = mysql_query ("SELECT * FROM suplier WHERE  s_i_code = '$s_i_code' ") or die (mysql_error());
	if(mysql_num_rows($query) == 0)
	{
	echo "<tr><td clospan =\"3\">No Post Were Found</td></tr>";
	}else{
...
<table width="1093"  height="38" border="0" style="background:#FBFBFD; margin-left:0;-moz-border-radius: 3px; table-layout:auto; margin-top:5px;">
  <tr>
    <td width="174" height="28" valign="top"><a style='text-decoration: none; color:Blue;'  href="home.php">Home</a>->Supplier Edit/Del</td>
  ...
  <tr>
   ...
   <td width="902" valign="top">
      <form action="" method="post">
        <input type="text" name="s_i_code" size="30"  required placeholder="Search By Company Code"/>
...
<div align="left">
<table width="auto" cellspacing="0" style="border: 1px solid black;">
	<thead>
	<tr>
